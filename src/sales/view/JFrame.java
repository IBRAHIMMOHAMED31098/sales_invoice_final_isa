 ...
 * @author IslamAmin
*/
import controllerinvoice.Salesinvoice;
...
public class JFrame extends javax.swing.JFrame {
    ...
    private ArrayList<InvoiceHeade> invoices;
    private Salesinvoice controller = new Salesinvoice(this);
    private InvoiceModel2 invoicesTableModel;
    
    

    public ArrayList<InvoiceHeade> getInvc() {
        if (invoices == null) invoices = new ArrayList<>();
        return invoices;
    }

    public void setInvoices(ArrayList<InvoiceHeade> invoices) {
        this.invoices = invoices;
    }
    
     public InvoiceModel2 getInvcTableModel() {
         if (invoicesTableModel == null) {
            invoicesTableModel = new InvoiceModel2(getInvc());
        }
        return invoicesTableModel;
    }

    public void setInvoicesTableModel(InvoiceModel2 invoicesTableModel) {
    ...
    public Salesinvoice getController() {
        return controller;
    }
     ...
     public int getNextInvoiceNum() {
        ...
        for (InvoiceHeade invoice : getInvc()) {
